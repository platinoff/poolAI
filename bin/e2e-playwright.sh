...
export POOLAI_HTTP_PORT POOLAI_RAID_BASE_PATH POOLAI_DATA_PATH POOLAI_JOB_STORE POOLAI_GALAXY_PRICING_FALLBACK_JSON RUST_LOG K8S_OPENAPI_ENABLED_VERSION
