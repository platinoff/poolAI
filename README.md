...
**PH-S03…S47, PH-S37 infra, PH-S44, PH-S42, PH-S43 закрито.** Канон черги — [`docs/catalog/FUNCTION_MANAGEMENT.md`](docs/catalog/FUNCTION_MANAGEMENT.md) **§5.1** · **§5.11**.

| # | Sprint | Фокус |
|---|--------|--------|
| 1 | **PH-S45** | E2E vm modal + axe audit |
| 2–4 | **PH-S38…S41** | job/on-chain, Solana, macvlan — див. §5.11 |
