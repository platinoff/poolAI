...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'admin.jobs.hint': 'Job queue from the coordinator store. Backend is set at startup via POOLAI_JOB_STORE.',
    ...
    uk: {
      ...
      'admin.jobs.hint': 'Черга задач координатора. Бекенд задається при старті через POOLAI_JOB_STORE.',
      'admin.jobs.store.json': 'JSON',
      'admin.jobs.store.sqlite': 'SQLite',
      'admin.jobs.store.raid': 'RAID',
      'admin.jobs.col.id': 'ID',
