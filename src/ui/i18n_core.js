...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'admin.updatesCompat.hint': 'Read-only Galaxy governance pointers. Policy prose lives in docs — not duplicated here.',
      'admin.updatesCompat.protocolTitle': 'Protocol version',
      'admin.updatesCompat.protocolHint': 'Coordinator wire baseline (PH-S65 protocol_compat). Workers send protocol_version on POST /api/v1/discovery/register-remote.',
      ...
      'admin.updatesCompat.compatStatusHint': 'Registration may return compat_status with HTTP 403/426 when the worker is outside the matrix window.',
      'admin.updatesCompat.verifyTitle': 'Verify signed release',
      'admin.updatesCompat.verifyHint': 'Operator quickstart — poolai-verify-release (PH-S66/S85). See SECURITY_HARDENING for the full checklist.',
      'admin.updatesCompat.link.security': 'SECURITY_HARDENING.md',
      'admin.updatesCompat.link.verifyQuickstart': 'Verify-release quickstart (PH-S71)',
      ...
      'admin.updatesCompat.matrixHint': 'Canonical compat matrix and negotiation rules — Galaxy §9.3. Implementation: src/grid/protocol_compat.rs.',
      'admin.updatesCompat.link.matrix': 'Galaxy §9.3 compat matrix (docs)',
      ...
      'admin.jobs.storeHint': 'Job persistence backend (POOLAI_JOB_STORE)',
      'admin.jobs.hint': 'Job queue from the coordinator store. Backend is set at startup via POOLAI_JOB_STORE. Lease columns are read-only; lease state badge is derived from lease_expires_at (Galaxy §4.3.1).',
      ...
      'admin.jobs.tooltip.leaseOwnerCol': 'Galaxy §4.3.1: holder of the active job lease',
      'admin.jobs.tooltip.leaseEpochCol': 'Monotonic CAS counter for renew / PATCH / grid result',
      'admin.jobs.tooltip.leaseStateCol': 'Derived from lease_expires_at vs coordinator clock',
      'admin.jobs.tooltip.leaseExpiresCol': 'UTC expiry; worker renew extends this timestamp',
      'admin.jobs.tooltip.leaseOwner': 'Galaxy §4.3.1: worker or peer id holding the active lease (acquire/renew CAS owner).',
      'admin.jobs.tooltip.leaseEpoch': 'Monotonic CAS generation; PATCH, renew, and grid result must match this epoch.',
      'admin.jobs.leaseState.active': 'Active',
      'admin.jobs.leaseState.expired': 'Expired',
      'admin.jobs.status.migrating': 'Migrating',
      'admin.jobs.tooltip.statusMigrating': 'Galaxy re-migrate: worker handoff in progress (PH-S104).',
      'admin.gridPricing.section': 'Grid pricing',
      'admin.gridPricing.hint': 'Read-only Galaxy pricing oracle snapshot. Configure L2 fallback via POOLAI_GALAXY_PRICING_FALLBACK_JSON when providers are unavailable.',
      ...
      'admin.gridPricing.loading': 'Loading pricing snapshot…',
      'admin.gridPricing.errLoad': 'Error loading pricing: ',
      'admin.gridPricing.errParams': 'Task and model profile are required.',
      'admin.gridPricing.resultTitle': 'Pricing snapshot',
      'admin.gridPricing.col.source': 'Source',
      'admin.gridPricing.col.freshness': 'Freshness',
      'admin.gridPricing.col.unitKey': 'Unit key',
      'admin.gridPricing.col.marketMin': 'Market min (μUSD)',
      'admin.gridPricing.col.poolaiQuote': 'PoolAI quote (μUSD)',
      'admin.gridPricing.col.provider': 'Provider at min',
      'admin.gridPricing.col.cachedAt': 'Cached at',
      ...
      'admin.raidadm.burstInactive': 'BurstRAID strategy not active on this node.',
      'admin.raidadm.swInactive': 'SmallWorld strategy not active on this node.',
      ...
      'admin.mon.mlEmptyHint': 'Run the demo pipeline or execute a pipeline via the AI/ML API.',
      'admin.mon.mlUnavailable': 'ML pipeline API unavailable',
      'admin.mon.mlUnavailableHint': 'Build with enterprise + ml features to enable AI/ML pipelines.',
    ...
    uk: {
      ...
      'admin.updatesCompat.hint': 'Read-only вказівники Galaxy governance. Повна політика — у docs, без дублювання тут.',
      'admin.updatesCompat.protocolTitle': 'Версія протоколу',
      'admin.updatesCompat.protocolHint': 'Базовий wire coordinator (PH-S65 protocol_compat). Воркери надсилають protocol_version на POST /api/v1/discovery/register-remote.',
      'admin.updatesCompat.col.coordinator': 'Протокол coordinator',
      'admin.updatesCompat.col.build': 'Збірка coordinator',
      'admin.updatesCompat.col.env': 'Env override',
      'admin.updatesCompat.compatStatusHint': 'Реєстрація може повернути compat_status з HTTP 403/426, якщо воркер поза вікном матриці.',
      'admin.updatesCompat.verifyTitle': 'Перевірка підписаного релізу',
      'admin.updatesCompat.verifyHint': 'Operator quickstart — poolai-verify-release (PH-S66/S85). Повний чекліст — SECURITY_HARDENING.',
      'admin.updatesCompat.link.security': 'SECURITY_HARDENING.md',
      'admin.updatesCompat.link.verifyQuickstart': 'Verify-release quickstart (PH-S71)',
      'admin.updatesCompat.link.manifest': 'RELEASE_MANIFEST_SAMPLE.md',
      'admin.updatesCompat.link.fixtures': 'Dev fixtures README',
      'admin.updatesCompat.matrixTitle': 'Матриця сумісності протоколу',
      'admin.updatesCompat.matrixHint': 'Канонічна матриця та правила negotiation — Galaxy §9.3. Код: src/grid/protocol_compat.rs.',
      'admin.updatesCompat.link.matrix': 'Galaxy §9.3 compat matrix (docs)',
      ...
      'admin.jobs.storeHint': 'Бекенд персистенції задач (POOLAI_JOB_STORE)',
      'admin.jobs.hint': 'Черга задач координатора. Бекенд — POOLAI_JOB_STORE. Колонки lease read-only; badge стану lease формується з lease_expires_at (Galaxy §4.3.1).',
      'admin.jobs.store.json': 'JSON',
      'admin.jobs.store.sqlite': 'SQLite',
      'admin.jobs.store.raid': 'RAID',
      'admin.jobs.col.id': 'ID',
      ...
      'admin.jobs.tooltip.leaseOwnerCol': 'Galaxy §4.3.1: хто тримає активний lease задачі',
      'admin.jobs.tooltip.leaseEpochCol': 'Монотонний CAS для renew / PATCH / grid result',
      'admin.jobs.tooltip.leaseStateCol': 'З lease_expires_at відносно годинника координатора',
      'admin.jobs.tooltip.leaseExpiresCol': 'UTC закінчення; worker renew подовжує timestamp',
      'admin.jobs.tooltip.leaseOwner': 'Galaxy §4.3.1: id воркера або peer з активним lease (acquire/renew CAS).',
      'admin.jobs.tooltip.leaseEpoch': 'Монотонний CAS; PATCH, renew і grid result мають збігатися з цим epoch.',
      'admin.jobs.leaseState.active': 'Активний',
      'admin.jobs.leaseState.expired': 'Протермінований',
      'admin.jobs.status.migrating': 'Міграція',
      'admin.jobs.tooltip.statusMigrating': 'Galaxy re-migrate: передача воркера в процесі (PH-S104).',
      'admin.gridPricing.section': 'Ціни Grid',
      'admin.gridPricing.hint': 'Read-only знімок Galaxy pricing oracle. L2 fallback — POOLAI_GALAXY_PRICING_FALLBACK_JSON, якщо провайдери недоступні.',
      ...
      'admin.gridPricing.errParams': 'Потрібні task та model profile.',
      'admin.gridPricing.resultTitle': 'Знімок цін',
      ...
      'admin.raidadm.burstInactive': 'Стратегія BurstRAID не активна на цьому вузлі.',
      'admin.raidadm.swInactive': 'Стратегія SmallWorld не активна на цьому вузлі.',
      ...
      'admin.mon.mlEmptyHint': 'Запустіть demo pipeline або виконайте pipeline через AI/ML API.',
      'admin.mon.mlUnavailable': 'ML pipeline API недоступний',
      'admin.mon.mlUnavailableHint': 'Зберіть з features enterprise + ml для AI/ML pipelines.',
