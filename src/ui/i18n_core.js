...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      'admin.jobs.hint': 'Job queue from the coordinator store. Backend is set at startup via POOLAI_JOB_STORE. Lease columns are read-only (Galaxy §4.3.1).',
    ...
    uk: {
      ...
      'admin.jobs.hint': 'Черга задач координатора. Бекенд — POOLAI_JOB_STORE. Колонки lease read-only (Galaxy §4.3.1).',
      'admin.jobs.store.json': 'JSON',
      'admin.jobs.store.sqlite': 'SQLite',
      'admin.jobs.store.raid': 'RAID',
      'admin.jobs.col.id': 'ID',
