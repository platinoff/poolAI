...
use crate::network::auth::{
    auth_middleware, get_global_user_manager, Claims, UserRole,
};
...
// System-related structs moved to api/system.rs
// StatusResponse, MetricsResponse, ModelInfo, HealthResponse, HealthChecks, HealthCheck
...
pub fn create_api_routes() -> Router {
    Router::new()
        ...
        // GPU and WebSocket routes moved to api/system.rs
...
// Re-exported from api::common for backward compatibility (via api/mod.rs)
pub(crate) use crate::network::api::check_permission;
...
// System handlers (status_handler, metrics_handler, models_handler) moved to api/system.rs
...
// System handlers (gpu_info, health_handler, login_handler) moved to api/system.rs
