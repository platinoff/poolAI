...
pub use dispatch::{
    ...
    ingest_job_prefetch_stub, locality_workers_from_seed_snapshots, noop_prefetch_hook,
    parse_prefetch_policy_mode, plan_prefetch, wait_prefetch_hook, GridIngestKind,
    GridIngestOutcome, PrefetchPlan, PrefetchPolicyConfig, PrefetchPolicyMode, PrefetchTrigger,
    SeedInventoryEntry, SeedInventoryPeerSnapshot, DEFAULT_PREFETCH_DEADLINE_MS, ENV_LOCALITY_MODE,
