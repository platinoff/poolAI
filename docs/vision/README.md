...
> **DEACTIVATED (band 117, 2026-08-07):** legacy Galaxy UI (`index.html` + `vision.js`/`vision.css`) визнаний superseded (bands 115–116). `docs/vision/index.html` тепер — вказівник на GSV; `vision.js`/`vision.css` лишаються як canon-архів (**не видаляємо**), але більше не завантажуються. Живий UI: **GSV** — `gsv-server` → `http://127.0.0.1:8891/` · [`GSV/docs/VISION.md`](../../GSV/docs/VISION.md) · [`GSV/docs/LEGACY_PARITY.md`](../../GSV/docs/LEGACY_PARITY.md) · [`GSV_MIGRATION.md`](../gsv/GSV_MIGRATION.md).
...
> **Live UI (band 117):** `gsv-server` → **`http://127.0.0.1:8891/`** · [`GSV_SERVER.md`](../gsv/GSV_SERVER.md) · [`GSV/docs/VISION.md`](../../GSV/docs/VISION.md). Нижче — застарілі інструкції для legacy-архіву: `docs/vision/index.html` тепер вказівник на GSV, `vision.js`/`vision.css` не завантажуються.
