...
**Оновлено:** 2026-06-14 · **Канон черги:** [`FUNCTION_MANAGEMENT.md`](../catalog/FUNCTION_MANAGEMENT.md) §5.12 (**10** відкритих PH-S179…S187)
...
## 3. Черга §5.12 (post-S178 replenish S179…S187)

| # | Sprint | Тема | Acceptance |
|---|--------|------|------------|
| — | **PH-S178** ✅ | Settlement pending_verification metrics | §6.4 grid result path |
| 1 | **PH-S179** | Replication strict tier metrics | §6.3 grid job ingest |
| 2 | **PH-S180** | Verification match metrics | §6.2 match counter |
| 3 | **PH-S181** | Pricing market min usd_micro metrics | §4.2 market min gauge |
| 4 | **PH-S182** | Trust score metrics | §6.2 trust score gauge |
| 5 | **PH-S183** | Shard local hit ratio metrics | §5.3 locality rank stub |
| 6 | **PH-S184** | Prefetch bytes total metrics | §5.5 `plan_prefetch` path |
| 7 | **PH-S185** | Cross region egress mb metrics | §5.3 rank/prefetch stub |
| 8 | **PH-S186** | Verification sample scheduled /metrics | §6.2 PH-S164 counter export |
| 9 | **PH-S187** | Settlement cleared total metrics | §6.4 Cleared grid result path |
