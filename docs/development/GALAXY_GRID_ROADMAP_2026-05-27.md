...
|---|--------|------|------------|
| — | **PH-S177** ✅ | Verification sample total metrics | §6.2 sample counter |
| 1 | **PH-S178** | Settlement pending_verification metrics | §6.4 grid result path |
| 2 | **PH-S179** | Replication strict tier metrics | §6.3 grid job ingest |
