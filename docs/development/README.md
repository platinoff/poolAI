...
- **[`GALAXY_GRID_ROADMAP_2026-05-27.md`](./GALAXY_GRID_ROADMAP_2026-05-27.md)** — роадмеп Galaxy Grid (PH-S65…S98 ✅, PH-S99…S103 відкрито); синхрон з FM §5.12.
...
- **[`NEXT_SESSION_PROMPT.md`](./NEXT_SESSION_PROMPT.md)** — поточний спринт **PH-S100**; §5.12 replenish **10** PH-S100…S109; закрито PH-S03…S99; [`OPENAPI_GAP_AUDIT_2026-05-19.md`](./OPENAPI_GAP_AUDIT_2026-05-19.md) §CI.
