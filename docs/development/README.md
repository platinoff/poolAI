...
- **[`GALAXY_GRID_ROADMAP_2026-05-27.md`](./GALAXY_GRID_ROADMAP_2026-05-27.md)** — роадмеп Galaxy Grid (PH-S65…S97, фази, наступні орієнтири); синхрон з FM §5.12.
...
- **[`NEXT_SESSION_PROMPT.md`](./NEXT_SESSION_PROMPT.md)** — поточний спринт **PH-S98**; закрито PH-S03…S97; [`OPENAPI_GAP_AUDIT_2026-05-19.md`](./OPENAPI_GAP_AUDIT_2026-05-19.md) §CI.
