...
- **[`NEXT_SESSION_PROMPT.md`](./NEXT_SESSION_PROMPT.md)** — промпт для копіювання в нову сесію (зараз **PH-S11** visual regression).
- **[`PROMETHEUS_METRICS.md`](./PROMETHEUS_METRICS.md)** · **[`OPENTELEMETRY_TRACING.md`](./OPENTELEMETRY_TRACING.md)** · **[`DESIGN_SYSTEM.md`](./DESIGN_SYSTEM.md)** · **[`../security/TLS.md`](../security/TLS.md)** — FM-043…045 (PH-S07…S09 ✅).
