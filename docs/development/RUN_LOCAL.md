...
URL (GSV, canon): `http://127.0.0.1:8891/` — див. [`GSV_SERVER.md`](../../GSV/docs/gsv/GSV_SERVER.md) · `GSV/docs/GSV_ROLES.md`. Legacy static server (`open-docs-vision.ps1`, `http://127.0.0.1:8765/GSV/docs/vision/index.html`) — деактивований (band 117), лишається архівом.
...
### GPULimits API contracts (band 123, PH-S1872)

```bash
VERIFY_GPU_LIMITS_API=1 bash bin/verify-dev-stand.sh
/usr/bin/bash bin/run-poolai.sh quick --gpu-limits-api
...
| `gpu_limits_api_criteria_met_count` | Criteria with marker present in canonical doc paths |
