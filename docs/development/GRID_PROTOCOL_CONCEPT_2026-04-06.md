...
> **Lease / worker heartbeat:** job lease CAS і `lease_epoch` на Grid `Result` — [`POOLAI_GALAXY_GRID.md`](../concept/POOLAI_GALAXY_GRID.md) §4.3.1–§4.3.1.1 · карта — [`GSV/docs/vision/`](../../GSV/docs/vision/).
