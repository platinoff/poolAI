...
**Galaxy map (PH-S120):** інтерактивний граф — [`docs/vision/`](../../docs/vision/) (`solana_concept` → `crate_solana` → `solana_sidecar` / `solana_program`); FM **FM-033** у [`FUNCTION_MANAGEMENT.md`](../catalog/FUNCTION_MANAGEMENT.md).
