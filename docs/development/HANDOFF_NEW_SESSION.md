...
1. Старт: [`NEXT_SESSION_PROMPT.md`](./NEXT_SESSION_PROMPT.md) — **PH-S13** (topology visual / VM/Raft); черга PH-S01…S14; ops LAN **BLOCKED**.
