...
**Оновлено:** 2026-05-25 (post PH-S37b + §5.11 PH-S37…S46) · ітераційні правила — [`.cursor/rules/poolai-session-iteration.mdc`](../../.cursor/rules/poolai-session-iteration.mdc)).
...
1. Старт: [`NEXT_SESSION_PROMPT.md`](./NEXT_SESSION_PROMPT.md) — **PH-S47** CI green (OpenAPI secrets, `raid_admin` test, E2E SIGSEGV) → **PH-S37** PNG → **PH-S44**; ops LAN **BLOCKED**; FM-041 Deferred.
