...
**Оновлено:** 2026-05-19 · **Гілка:** `main` · **Зріз комітів:** S28 (OpenAPI gap audit)  
...
|---------|------|---------|
| OpenAPI повний `rg` audit | Partial ✅ S14–S28 | v1 Users/RAID/VM; backlog `/raid/distributed/*` |
...
|--------|--------|--------|
| 1 | Playwright security/audit E2E | за `E2E_PLAYWRIGHT.md` |
