...
- ◆ **FM-003 (Planned ops):** LAN-заміри — [`LAN_BENCHMARK_RUNBOOK.md`](../performance/LAN_BENCHMARK_RUNBOOK.md) §5 dev stand (`POOLAI_HTTP_PORT`, `bin/run-lan-nodes.*`, 8080+8081 на одній машині **2026-05-18**); §4 ops sign-off відкритий; baseline `poolai_health_load` — **2026-04-10** у `BENCHMARKS.md`.
