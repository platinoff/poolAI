...
- ✅ **PH-SVC55…64 (2026-07-24):** PEMs/`data/audit/*.log.gz` зняті з git index; `.gitignore` + permissions block secrets; local TLS regenerate `CN=localhost` — [`certs/README.md`](../../certs/README.md).
