...
- [`development/NEXT_DEVELOPMENT_PHASE.md`](./development/NEXT_DEVELOPMENT_PHASE.md) - Наступна фаза розробки
...
**Примітка**: Всі нові документи повинні створюватися в цій структурі. README.md та README.uk.md залишаються в корені проекту.
