...
| **Services** | `services/` | `RaidService`, `VmService`, `LibraryService`, `DiscoveryService`, `TopologyService`, `EnterpriseService`, `CloudService`, `AdminService` — оркестрація для HTTP. |
