...
| **Services** | `services/` | `RaidService`, `VmService`, `LibraryService`, `DiscoveryService`, `TopologyService`, `WorkerPoolService`, `EnterpriseService`, `CloudService`, `AdminService` — оркестрація для HTTP. |
