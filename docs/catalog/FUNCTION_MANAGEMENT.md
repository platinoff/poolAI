...
| 2 | UI a11y backlog | **FM-019** | Dashboard modals ✅ (2026-05-18); backlog: pa11y/axe CI — [`ADMIN_A11Y_RUNBOOK.md`](../development/ADMIN_A11Y_RUNBOOK.md) §5 |
...
| FM-019 | pa11y/axe у CI | **Backlog** | baseline ✅; dashboard modals partial ✅ 2026-05-18 |
...
2. **FM-019 backlog** — pa11y/axe CI (optional workflow).
...
**Поточний:** [`AUTO_RUN_SESSION_2026-06-09.md`](../development/AUTO_RUN_SESSION_2026-06-09.md) (FM-019 dashboard modals).

**Завершено (partial):** FM-019 dashboard modals — `src/ui/mod.rs`, `ui::dashboard_a11y_tests`.
