...
**Наступна сесія (код/CI):** **PH-S48** (job RAID store). **Не стартувати без інфра:** PH-S35, PH-S36 без запиту.
...
**Наступна сесія:** **PH-S48** · [`NEXT_SESSION_PROMPT.md`](../development/NEXT_SESSION_PROMPT.md).
