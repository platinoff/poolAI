...
| OpenAPI | Синхронізація при нових маршрутах | **Partial** | S14–S15: FM-016 discovery + Telegram у `openapi.yaml`; admin/topology — ongoing |
...
2. **OpenAPI** — sync з `src/network/` при наявності API diff (S14–S15 ✅ FM-016 discovery/Telegram; admin/topology — ongoing).
