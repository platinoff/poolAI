...
| OpenAPI | Синхронізація при нових маршрутах | **Partial** | S14–S17: discovery/Telegram/admin/topology/instances/config/ui/completions/ai-ml pipeline; enterprise OAuth — ongoing |
