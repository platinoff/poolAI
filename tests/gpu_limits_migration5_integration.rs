...
use poolai_ui_core::gpu_limits_migration5_depth::{
    gpu_limits_migration5_criteria_total, gpu_limits_migration_depth5_stub, GpuLimitsMigrationDepth5,
    GPU_LIMITS_MIGRATION5_CASES, GPU_LIMITS_MIGRATION5_CRITERIA,
};
use serde_json::json;
