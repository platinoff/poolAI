...
use poolai_ui_core::gpu_limits_migration6_depth::{
    gpu_limits_migration6_criteria_total, gpu_limits_migration_depth6_stub, GpuLimitsMigrationDepth6,
    GPU_LIMITS_MIGRATION6_CASES, GPU_LIMITS_MIGRATION6_CRITERIA,
};
use serde_json::json;
