...
//! PH-S46 wire limits + production devnet deploy path.
...
pub use instruction::{AnchorMode, PoolAiInstruction, MEMO_PROGRAM_ID, PLACEHOLDER_PROGRAM_ID};
pub use rpc::{
...
pub use wire_limits::{
    validate_envelope, validate_instruction_data, WireValidationError, MAX_DOMAIN_ID_LEN,
    MAX_EVENT_ID_LEN,
};
